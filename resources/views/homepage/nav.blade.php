				...
				<div class="col_half fright col_last nobottommargin">
					...
					<div id="top-social">
						<ul>
							...
							<li><a href="tel:+92 300 1234567" class="si-call"><span class="ts-icon"><i class="icon-call"></i></span><span class="ts-text">+92 300 1234567</span></a></li>
							<li><a href="mailto:info@canvas.com" class="si-email3"><span class="ts-icon"><i class="icon-email3"></i></span><span class="ts-text">info@businesslive4u.com</span></a></li>
						</ul>
					</div>
					<!-- #top-social end -->
				</div>
		...
		<header id="header">
			<div id="header-wrap">
				<div class="container clearfix">
					...
					<!-- Logo ============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" data-dark-logo="images/bl4ulogo.png"><img src="images/bl4ulogo.png" alt="Canvas Logo"></a>
						<a href="index.html" class="retina-logo" data-dark-logo="images/bl4ulogo.png"><img src="images/bl4ulogo.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						<!-- Primary Navigation
						============================================= -->
				...
				<li class="mega-menu"><a href="#"><div>Ranks</div></a>
			</li>
			<li class="mega-menu"><a href="#"><div>Business Planes</div></a>
		</li>
		<li><a href="shop.html"><div>Products</div></a>
	</li>
...
<section id="slider" class="slider-element slider-parallax swiper_wrapper full-screen clearfix" data-autoplay="5000"  data-speed="600" data-loop="true">
<div class="slider-parallax-inner">
<div class="swiper-container swiper-parent">
<div class="swiper-wrapper">
	<!-- 	<div class="swiper-slide dark" style="background-image: url('images/slider/swiper/114.png');">
			<div class="container clearfix">
					<div class="slider-caption slider-caption-center">
							<h2 data-animate="fadeInUp">Welcome to Business Live 4 U</h2>
	...
	<div class="swiper-slide dark" style="background-image: url('images/slider/swiper/14.jpg');">
		<div class="container clearfix">
			<div class="slider-caption slider-caption-center">
				<!-- <h2 data-animate="fadeInUp">Business Live 4 U</h2> -->
	...
	<div class="swiper-slide dark" style="background-image: url('images/slider/swiper/8.jpg');">
		<div class="container clearfix">
			<div class="slider-caption slider-caption-center">
				<!-- <h2 data-animate="fadeInUp">Bravo</h2>
				<p class="d-none d-sm-block" data-animate="fadeInUp" data-delay="200">Create just what you need for your Perfect Website. Choose from a wide range of Elements &amp; simply put them on our Canvas.</p> -->
			</div>
		</div>
	</div>
	<div class="swiper-slide dark">
		...
		<div class="video-wrap">
			<video poster="images/videos/explore.jpg" preload="auto" loop autoplay muted>
				...
				<!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/RTU8SXoFmO0?autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
...
<div>
	<div class="container clearfix">
		<span class="badge badge-warning bnews-title">Breaking News:</span>
...
<div class="tabs tabs-bordered clearfix" id="tab-3">
	<ul class="tab-nav tab-nav2 clearfix">
		<li><a href="#tabs-9">Future Properties</a></li>
		<li><a href="#tabs-10">Bravo Home</a></li>
		<li><a href="#tabs-11">Bravo Taxi</a></li>
		<li><a href="#tabs-12">B4U Foundation</a></li>
	</ul>
...
<div class="clear"></div>
<h4>Ranks & Incentives</h4>
<div class="offset-md-3">
<a href="#myModal1" data-lightbox="inline" class="button button-blue button-rounded">Silver & Gold</a>
<a href="#Aurora" data-lightbox="inline" class="button button-amber button-rounded">Coordinator & Executive</a>
<a href="#cullinan" data-lightbox="inline" class="button button-teal button-rounded">Diamond & Platinum</a>
</div>
<!-- Modal -->
<div class="modal1 mfp-hide" id="myModal1">
	<div class="block divcenter" style="background-color: #FFF; max-width: 1000px;">
		<div class="feature-box fbox-center fbox-effect nobottomborder nobottommargin" style="padding: 40px;">
			<img src="images/ranks/bluemoon.png">
		</div>
	</div>
</div>
<!-- Modal2 -->
<div class="modal1 mfp-hide" id="Aurora">
	<div class="block divcenter" style="background-color: #FFF; max-width: 1000px;">
		<div class="feature-box fbox-center fbox-effect nobottomborder nobottommargin" style="padding: 40px;">
			<img src="images/ranks/aurora.png">
		</div>
	</div>
</div>
<!-- Modal3 -->
<div class="modal1 mfp-hide" id="cullinan">
	<div class="block divcenter" style="background-color: #FFF; max-width: 1000px;">
		<div class="feature-box fbox-center fbox-effect nobottomborder nobottommargin" style="padding: 40px;">
			<img src="images/ranks/cullinan.png">
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-lg-3 col-md-6 bottommargin">
		...
		<ul class="skills">
			...
			<li data-percent="70">
				<span>Customer Satisfation</span>
				<div class="progress">
...
<div class="container clearfix">
<div class="col_half">
Copyrights &copy; 2019 All Rights Reserved by Business Live 4 U.<br>
